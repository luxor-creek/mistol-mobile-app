import svgPaths from "./svg-bsvg8sso9h";
...
function Button() {
  return (
    <div className="bg-[#daea69] content-stretch flex items-center justify-center overflow-clip px-[12px] py-[10px] relative rounded-[30px] shrink-0 size-[50px]" data-name="Button">
        ...
        <div className="absolute inset-[95.83%_33.33%_4.17%_33.33%]" data-name="Vector">
          <div className="absolute inset-[-0.75px_-9.38%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.5 1.5">
              <path d="M0.75 0.75H8.75" id="Vector" stroke="var(--stroke-0, #1F2121)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
        <div className="absolute bottom-[4.17%] left-1/2 right-1/2 top-[79.17%]" data-name="Vector">
          <div className="absolute inset-[-18.75%_-0.75px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1.5 5.5">
              <path d="M0.75 0.75V4.75" id="Vector" stroke="var(--stroke-0, #1F2121)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[4.17%_37.5%_37.5%_37.5%]" data-name="Vector">
          <div className="absolute inset-[-7.14%_-16.67%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 16">
              <path d={svgPaths.p2ee11db0} id="Vector" stroke="var(--stroke-0, #1F2121)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[41.67%_20.83%_20.83%_20.83%]" data-name="Vector">
          <div className="absolute inset-[-11.11%_-7.14%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 11">
              <path d={svgPaths.p18b32a80} id="Vector" stroke="var(--stroke-0, #1F2121)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
            </svg>
          </div>
        </div>
      </div>
...
export default function Component17StartVoiceChat() {
  return (
    <div className="bg-[#f1f6f6] relative size-full" data-name="17. Start Voice Chat">
      <Background />
      <div className="absolute backdrop-blur-[2px] bg-[rgba(168,176,176,0.8)] h-[812px] left-0 top-0 w-[375px]" data-name="Overlay" />
      <div className="-translate-x-1/2 absolute bg-white bottom-[42px] content-stretch flex flex-col gap-[16px] items-center left-1/2 overflow-clip px-[18px] py-[24px] rounded-[22px] w-[351px]" data-name="Audio Record">
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] min-w-full relative shrink-0 text-[#595e5e] text-[14px] text-center w-[min-content]">
          <p className="leading-[1.3] mb-0">Hold a button below to record</p>
          <p className="leading-[1.3]">your voice chat</p>
        </div>
        <Button />
        <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium h-[16px] justify-center leading-[0] relative shrink-0 text-[#ef4444] text-[14px] text-center w-[134px]">
